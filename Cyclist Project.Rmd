...
colnames(May_2022)
```
Checking if the columns have the same datatypes. 
...
Creating a new version of the dataset that combines the start_station_name and the end_station_name to serve as an aggregate form of each ride route.
```{r}
